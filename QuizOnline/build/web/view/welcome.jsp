        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="${pageContext.request.contextPath}\Servlet/History">History</a>
        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div style="text-align: center;">
                    <h1>Welcome To Quiz Huy</h1>
                    <h4>Take A Quiz!</h4>
                    <c:forEach var="subject" items="${subjectList}">
                        <a href="${pageContext.request.contextPath}\Servlet/QuizServlet?subjectId=${subject.getSubjectId()}" class="m-2  btn btn-outline-primary btn-lg ml-auto">${subject.getSubjectName()}</a>  
                    </c:forEach>
